            ...
            <Tabs defaultActiveKey="3">
                <TabPane tab="Contexte" key="1">
                    ...
                    <p>
                        ...
                        ou le fruit d’autres situations déterminées (réaction à la suite d’un tatouage...). Le portail propose aujourd’hui une vingtaine de catégories différentes. On dénombre en 2020 60 000 déclarations depuis l’ouverture du portail en mars 2017. Chaque déclaration contient une centaine de champs, données structurées ou champs libres.
                    </p>
                    <p>
                    ...
                    <p><br/></p>
                    <p>
                        Dans ce cadre, le projet s'est particulièrement appliqué aux déclarations de <i>matériovigilance</i> et de <i>réactovigilance</i>. Il s'est attaché à :
                    </p>
                    <ul>
                        <li>
                            <b>coder automatiquement diverses variables</b> des déclarations : dispositif médical (DCO), dysfonctionnement, effet et conséquences
                        </li>
                        <li>
                            <b>estimer la gravité des incidents</b>
                        </li>
                        <li>
                            <b>rapprocher chaque déclaration de déclarations existantes</b>
                        </li>
                        <li>
                    ...
                    <Collapse>
                        <Panel header={<h2>1. Techniques de classification</h2>}>
                            ...
                            <ul>
                                ...
                                <li><b>inférence du type de dysfonctionnement</b> : problème multi-classe et multi-label avec environ 800 classes</li>
                                <li><b>inférence du type de d'effet</b> : problème multi-classe et multi-label avec environ 250 classes</li>
                                <li><b>inférence du type de consequence</b> : problème multi-classe et multi-label avec environ 70 classes </li>
                                <li><b>inférence du niveau de gravité</b> : problème multi-classe ordonées à 5 classes </li>
                            </ul>
                                ...
                                <li><h3> Séparation  en jeu de donnée d'entrainement et de test</h3></li>
                                    ...
                                    <ul>
                                        ...
                                        <p>
                                            ...
                                            Nous devons donc adapter nos métriques et notre séparation train/test à cette configuration.
                                        </p>
                                    </ul>
                                    <p>
                                        Pour dépasser ces difficultés, nous avons utilisé la <b>description complète de l'incident comme identifiant d'une déclaration</b> et une méthode appelée <a href="http://scikit.ml/stratification.html" target="_blank">stratification de données multi-labels</a> qui permet de s'assurer une répartition intelligente des données similaires entre train et test.
                                    </p>

                                <li><h3> Choix des métriques d'évaluation </h3></li>
                                    <p>
                                        Nous avons choisi différents indicateurs de performance pour les différentes variables en fonction des besoins et de la structure des données :
                                    </p>
                                    <ul>
                        ...
                        <Panel header={<h2>2. Techniques de clustering</h2>}>
                            ...
                            <ol>
                                ...
                                <ul>
                                    <li><b>Lors de la clusterisation d'un nouveau document :</b> le tableau "topics" montre les topics expliquant le mieux le document, et la probabilité associée.</li>
                ...
                <TabPane tab="Explication des visualisations" key="3">
                    <ol>
                        ...
                        <ul>
                            <li><b>Son poids dans le corpus</b> : c'est le pourcentage d'occurences de mots qui lui sont attribués.</li>
                        ...
                        <ul>
                            ...
                            <li><b>Ses topics majoritaires</b> : calculés en agrégeant les scores des topics des documents du cluster.</li>
                            <li><b>Ses DCOs majoritaires</b> : calculées en agrégeant les DCO déclarées des documents du cluster.</li>
                        ...
                        <ul>
                            ...
                            <li><b>Une visualisation en 2d des clusters</b> : en rentrant un numéro dans le champ de recherche ou en cliquant sur une bulle, vous pourrez visualiser
